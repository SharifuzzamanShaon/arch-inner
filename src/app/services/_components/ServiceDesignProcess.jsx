    ...
    <Container>
      <div className="py-10 sm:py-12 md:py-16">
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-8 items-center">
          <div className="space-y-10 sm:space-y-14 lg:space-y-24 order-2 lg:order-1">
            {[processes[0], processes[2], processes[4]].map((item, idx) => (
              <div
                key={idx}
                className={`flex gap-4 ${item.flexDir} ${item.align}`}
              >
          ...
          <div className="order-1 lg:order-2 flex justify-center items-end lg:items-center">
          ...
          <div className="space-y-16 lg:space-y-24 order-3">
            {[processes[1], processes[3], processes[5]].map((item, idx) => (
              <div
                key={idx}
                className={`flex gap-4 ${item.flexDir} ${item.align}`}
              >
