      ...
      <div className="relative w-full bg-white h-[56vh] min-h-85 sm:h-[80vh] sm:min-h-110 sm:max-h-240">
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <div className="max-w-360 mx-auto px-6 sm:px-10 lg:px-16 pb-8 sm:pb-10 flex items-end justify-between">
            <span className="bg-white/10 backdrop-blur-sm text-white text-[10px] tracking-[0.22em] uppercase px-3 py-1.5 border border-white/15 font-normal">
              {project.category}
            </span>
            <div className="flex items-center gap-4 text-[10px] tracking-[0.2em] uppercase text-white/45 font-normal">
