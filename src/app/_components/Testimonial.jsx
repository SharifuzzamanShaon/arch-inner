      ...
      <div className="max-w-360 mx-auto px-6 sm:px-10 lg:px-16 py-20 sm:py-28">
        ...
        <div ref={gridRef} className="relative -mx-6 md:mx-0">
          ...
          <button
            ...
            aria-label="Previous"
            className="hidden lg:flex absolute -left-14 top-1/2 -translate-y-1/2 z-10 w-11 h-11 items-center justify-center text-white/70 hover:text-[#1C1917] hover:bg-white transition-all duration-200 cursor-pointer"
          >
          ...
          <button
            ...
            aria-label="Next"
            className="hidden lg:flex absolute -right-14 top-1/2 -translate-y-1/2 z-10 w-11 h-11 items-center justify-center text-white/70 hover:text-[#1C1917] hover:bg-white transition-all duration-200 cursor-pointer"
          >
            <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
              <path
                d="M6 4L10 8L6 12"
